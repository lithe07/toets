    ...
    # === [kamer 6] === #
        ...
        if zombie_hit_damage <= 0:
            ...
            if player_attack_amount < zombie_attack_amount:
                ...
                player_attack += 1
                print(f'Je health is nu {player_health} en je hebt een attack gekregen en je huidige attack is  {player_attack}.')
...
if kamer3_keuze == 11:
    ...
    if zombie_hit_damage <= 0:
        ...
        if player_attack_amount < zombie_attack_amount:
            ...
            print("Hier ligt het zwaard en deze is dus alleen te bereiken met de bom.")
            zwaard = input("Wil je de zwaard halen (ja/nee)? ")
            # === [kamer 13] === #
            print("# === [kamer 13] === #")
            if zwaard == 'ja':
                boom  = False
                player_attack += 2
                print("Je hebt een zwaard gekregen")
            else:
                print("Je kan door naar andere kamers")
        else:
            print('Helaas is de zombie te sterk voor je.')
            print('Game over.')
            exit()
...
if zombie_hit_damage <= 0:
    ...
    player_attack_amount = math.ceil(derde_zombie_health / max(player_hit_damage, 1))
